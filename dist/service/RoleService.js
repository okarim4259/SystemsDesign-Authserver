...
let RoleService = class RoleService {
    ...
    getRoleByName(_roleName) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._roleDAO.getRoleByName(_roleName);
        });
    }
    getPermission(_roleId) {
        return __awaiter(this, void 0, void 0, function* () {
...
RoleService = __decorate([
    ...
    __param(0, inversify_1.inject(types_1.TYPE.RoleDAO)),
    __metadata("design:paramtypes", [RoleDAO_1.RoleDAO])
], RoleService);
