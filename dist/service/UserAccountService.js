...
let UserAccountService = class UserAccountService {
    ...
    registerNewUser(newUser) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._userAccountDAO.createNewUser(newUser);
        });
    }
    getUserRoles(_userRefid) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._userAccountDAO.getUserRoles(_userRefid);
        });
    }
};
UserAccountService = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.TYPE.UserAccountDAO)),
    __metadata("design:paramtypes", [UserAccountDAO_1.UserAccountDAO])
], UserAccountService);
